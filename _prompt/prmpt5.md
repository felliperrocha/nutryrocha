...
## Regras importantes
- Todos os dados devem ser carregados do NeonDB em tempo real
- Todas as alterações devem ser salvas no NeonDB
...
- Não remover o que já está feito no projeto, apenas adicione o que está sendo pedido
- Remova a animação que foi já está feita no design do gráfico (bolinhas saltando)
- Correção da gramática: nomes de seções devem iniciar com letra maiúscula, reveja o sistema como um todo e corrija isso.